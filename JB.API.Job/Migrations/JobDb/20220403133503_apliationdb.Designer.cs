...
namespace JB.Job.Migrations
{
    ...
    [Migration("20220403133503_apliationdb")]
    partial class apliationdb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JB.Job.Models.Job.ApplicationModel", b =>
                {
            ...
            modelBuilder.Entity("JB.Job.Models.Job.CategoryModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("JB.Job.Models.Job.InterestModel", b =>
                {
                    b.Property<int>("JobId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("JB.Job.Models.Job.JobModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("JB.Job.Models.Job.PositionModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("JB.Job.Models.Job.SkillModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("JB.Job.Models.Job.TypeModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CategoryModelJobModel", b =>
                {
                    b.HasOne("JB.Job.Models.Job.CategoryModel", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JB.Job.Models.Job.JobModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("JB.Job.Models.Job.ApplicationModel", b =>
                {
                    b.HasOne("JB.Job.Models.Job.JobModel", "Job")
            ...
            modelBuilder.Entity("JobModelPositionModel", b =>
                {
                    ...
                    b.HasOne("JB.Job.Models.Job.PositionModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("JobModelSkillModel", b =>
                {
                    ...
                    b.HasOne("JB.Job.Models.Job.SkillModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("JobModelTypeModel", b =>
                {
                    ...
                    b.HasOne("JB.Job.Models.Job.TypeModel", null)
                        .WithMany()
