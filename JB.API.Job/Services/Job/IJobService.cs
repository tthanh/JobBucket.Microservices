...
namespace JB.Job.Services
{
    public interface IJobService : IServiceBase<JobModel>
    {
        ...
        Task<(Status, List<JobModel>)> GetRecommendations(JobModel entity, Expression<Func<JobModel, bool>> filter = null, Expression<Func<JobModel, object>> sort = null, int size = 10, int offset = 1, bool isDescending = false);
