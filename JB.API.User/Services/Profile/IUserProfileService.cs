...
namespace JB.User.Services
{
    public interface IUserProfileService : IServiceBase<UserProfileModel>
    {
        ...
        Task<(Status, List<UserProfileModel>)> GetRecommendations(UserProfileModel entity = null, Expression<Func<UserProfileModel, bool>> filter = null, Expression<Func<UserProfileModel, object>> sort = null, int size = 10, int offset = 1, bool isDescending = false);
